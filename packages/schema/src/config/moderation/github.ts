...
export const github = {
  ...
  properties: {
    ...
    'head_branch_{}': {
      ...
      description:
        'Specifies the head branch of the new comment, e.g. `comment-123`.',
      type: 'string',
      pattern: '^[\\s\\S]*$',
      maxLength: 256,
...
\n> {{ comment.txt | split(pat="\r\n") | join(sep="\n> ") }}"""`,
    ...
    '&commit_msg_{}': {
      ...
      description:
        'Specifies a file that has the commit message of the new comment.',
      type: 'string',
    ...
    '&pr_body_{}': {
      ...
      description:
        'Specifies a file containing the PR body of the new comment.',
      type: 'string',
      format: 'uri-reference',
